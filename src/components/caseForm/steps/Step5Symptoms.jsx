    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1 sm:gap-2 sm:grid-cols-3 lg:grid-cols-4">
          {SYMPTOM_TYPES.map((symptom) => (
            <label
              key={symptom}
              className="flex items-center p-1 sm:p-2 border border-gray-300 rounded hover:bg-gray-50 cursor-pointer transition text-xs"
            >
              <input
                type="checkbox"
      ...
      <div className="space-y-3 sm:space-y-4 pt-3 sm:pt-4">
        ...
        <div>
          ...
          {errors.symptomDaily && (
            <p className="mt-1 text-xs text-red-600">{errors.symptomDaily}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onNestedInputChange("symptoms", "symptomLocation", e.target.value)
            }
            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 text-sm sm:text-base ${
              errors.symptomLocation
                ? "border-red-500 focus:ring-red-500"
                : "border-gray-300 focus:ring-blue-600"
            }`}
